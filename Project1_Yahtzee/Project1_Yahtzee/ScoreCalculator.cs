...
namespace Project1_Yahtzee
{
    ...
    public static class ScoreCalculator
    {
        ...
        /// <remarks>
        /// This isn't the most efficient way of doing this because we're calculating scores that may have already been
        /// selected in the scorecard, but in this case increasing efficiency would require increasing coupling. This
        /// way, the scoring calculator doesn't need to know anything about the rest of the program.
        ///
        /// We could potentially have the GUI call only the scoring methods it needs, but then that class would have to
        ...
        /// <summary>
        /// Of the five dice, this is the maximum index the first die of a small straight can have and still leave room
        /// to complete the small straight.
        /// </summary>
        ...
        /// <summary>
        /// Calculate the upper section aces score. The score is the sum of all the dice with a one showing. 
        /// </summary>
        ...
        /// <summary>
        /// Calculates the score for a roll containing a certain number of dice showing the same face. The score is the
        /// sum of all of the dice if the minimum count is met.
        /// </summary>
        /// <param name="dice"> Sorted list of the die faces that have been rolled. </param>
        ...
        /// <summary>
        /// Calculate the upper section fives score. The score is the sum of all the dice with a five showing. 
        /// </summary>
        /// <param name="dice"> Sorted list of the die faces that have been rolled. </param>
        ...
        /// <summary>
        /// Calculates the score for rolling a four of a kind. The score is the sum of all of the dice if there are four
        /// dice with the same face.
        /// </summary>
        /// <param name="dice"> Sorted list of the die faces that have been rolled. </param>
        ...
        /// <summary>
        /// Calculate the upper section fours score. The score is the sum of all the dice with a four showing. 
        /// </summary>
        /// <param name="dice"> Sorted list of the die faces that have been rolled. </param>
        ...
        {
            // We can assume that if there is a full house then the lowest index will contain one of the faces and the
            // highest index with contain the other.
        ...
        /// <summary>
        /// Calculate the upper section sixes score. The score is the sum of all the dice with a six showing. 
        /// </summary>
        /// <param name="dice"> Sorted list of the die faces that have been rolled. </param>
        ...
        /// <summary>
        /// Calculates the score for rolling a three of a kind. The score is the sum of all of the dice if there are
        ...
        /// <summary>
        /// Calculate the upper section threes score. The score is the sum of all the dice with a three showing. 
        /// </summary>
        /// <param name="dice"> Sorted list of the die faces that have been rolled. </param>
        ...
        /// <summary>
        /// Calculate the upper section twos score. The score is the sum of all the dice with a two showing. 
        /// </summary>
        /// <param name="dice"> Sorted list of the die faces that have been rolled. </param>
        ...
        /// <summary>
        /// Calculate the upper section score for a specific die face for a dice roll. The score is the sum of all the
        /// die with the specified face.
        /// </summary>
        /// <param name="dice"> Sorted list of the die faces that have been rolled. </param>
