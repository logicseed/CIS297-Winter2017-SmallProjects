...
namespace Project1_Yahtzee
{
    ...
    public abstract class AbstractGameState
    {
        ...
        /// <returns></returns>
        public virtual bool SetKeepDieRoll(GameManager game, DiceRoller roller, int die, bool keep)
        {
    ...
    {
        public override bool SetKeepDieRoll(GameManager game, DiceRoller roller, int die, bool keep)
        {
            return false;
        }
