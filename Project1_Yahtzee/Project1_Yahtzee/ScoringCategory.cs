...
namespace Project1_Yahtzee
{
    ...
    /// </summary>
    /// <remarks>
    /// Because we need to enumerate over the scoring categories frequently we will use a pseudo- Singleton that will
    /// generate the list of scoring categories the first time it is requested and then reuse that list for future requests.
    /// </remarks>
